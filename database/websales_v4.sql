...
[Id] ASC
    ...
    INSERT [dbo].[Customers] ([Id], [Password], [Fullname], [Email], [Photo], [Activated], [Admin], [PhoneNumber], [Address], [IsChangePassword]) VALUES (N'12134567', N'sssss', N'Trịnh Tuấn Vũ', N'test@gmail.com', N'Phôt.png', 1, 1,'0117361231','HCM', 1)
    INSERT [dbo].[Customers] ([Id], [Password], [Fullname], [Email], [Photo], [Activated], [Admin], [PhoneNumber], [Address], [IsChangePassword]) VALUES (N'hien123', N'123456', N'Dương Thị Hiền', N'trinhtuanvuu@gmail.com', N'user.png', 1, 0,'0117361231','HCM', 1)
    INSERT [dbo].[Customers] ([Id], [Password], [Fullname], [Email], [Photo], [Activated], [Admin], [PhoneNumber], [Address], [IsChangePassword]) VALUES (N'hien123456', N'123456', N'Dương Thị Hiền', N'hien.qthk12@gmail.com', N'user.png', 0, 0,'0117361231','HCM', 1)
    INSERT [dbo].[Customers] ([Id], [Password], [Fullname], [Email], [Photo], [Activated], [Admin], [PhoneNumber], [Address], [IsChangePassword]) VALUES (N'trinhtuanvu', N'123', N'Trịnh Tuấn Vũ', N'trinhtuanvuu@gmail.com', N'avata_cv.jpg', 1, 1,'0117361231','HCM', 1)
    INSERT [dbo].[Customers] ([Id], [Password], [Fullname], [Email], [Photo], [Activated], [Admin], [PhoneNumber], [Address], [IsChangePassword]) VALUES (N'tuanvu', N'123456', N'Trinh Tuan Vu', N'tuanvuplbp@gmail.com', N'avata_cv.jpg', 1, 1,'0117361231','HCM', 1)
    INSERT [dbo].[Customers] ([Id], [Password], [Fullname], [Email], [Photo], [Activated], [Admin], [PhoneNumber], [Address], [IsChangePassword]) VALUES (N'vuongha', N'123', N'Vương', N'tuanvuplbp@gmail.com', N'user.png', 1, 0,'0117361231','HCM', 1)
    ...
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (10, N'trinhtuanvu', CAST(N'2020-10-26 00:00:00.000' AS DateTime), N'', 117.5, N'', 0, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (11, N'vuongha', CAST(N'2020-10-31 00:00:00.000' AS DateTime), N'25 man thiện p.hiep phu quận 9', 91.8, N'<i><u style="background-color: rgb(51, 102, 153);"><font color="#6600ff">test</font></u></i>', 2, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (12, N'vuongha', CAST(N'2020-11-03 00:00:00.000' AS DateTime), N'25 man thiện p.hiep phu quận 9', 214.2, N'<br>', 4, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (13, N'tuanvu', CAST(N'2020-11-08 00:00:00.000' AS DateTime), N'25 man thiện', 12.5, N'', 1, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (14, N'tuanvu', CAST(N'2020-11-08 00:00:00.000' AS DateTime), N'25 man thiện', 33.9, N'test', 0, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (15, N'tuanvu', CAST(N'2020-11-14 00:00:00.000' AS DateTime), N'25 man thiện', 98.9, N'', 1, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (16, N'tuanvu', CAST(N'2022-03-02 00:00:00.000' AS DateTime), N'binh phuoc', 15.5, N'', 1, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (17, N'hien123', CAST(N'2022-03-02 00:00:00.000' AS DateTime), N'28/28 Văn Chung Q .Tân Bình', 194.5, N'giao thứ 7', 0, 3)
    INSERT [dbo].[Orders] ([Id], [CustomerId], [OrderDate], [Address], [Amount], [Description], [Status], [PartnerId]) VALUES (18, N'hien123', CAST(N'2022-03-02 00:00:00.000' AS DateTime), N'25 man thiện p.hiep phu quận 9', 19, N'', 1, 3)
